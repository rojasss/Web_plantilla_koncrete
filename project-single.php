                                    ...
                                    <ul class="nav navbar-nav mb-2 mb-lg-0">
                                        ...
                                        <li class="menu-item-has-children">
                                            ...
                                            <ul class="sub-menu">
                                                ...
                                                <li><a class="active" href="project-single.php">Project Single</a></li>
                        ...
                        <div class="wpo-minimal-wrap">
                            ...
                            <ul>
                                <li class="video-holder">
                                    <a href="https://www.youtube.com/embed/jAPsZ7_4bxg?autoplay=1" class="video-btn"
                            ...
                            <div class="widget category-widget">
                                <h3>Services</h3>
                                 <ul>
                                    ...
                                    <li><a href="service-single.php">Floor and Roofs</a></li>
                                    <li><a href="service-single.php">Electricity</a></li>
 <li><a href="service-single.php">Plumbing Construction</a></li>
                                    <li><a href="service-single.php">Road Construction</a></li>
                                    <li><a href="service-single.php">OutFiled Digging</a></li>
 <li><a href="service-single.php">Renovation</a></li>
                                </ul>
                            </div>
