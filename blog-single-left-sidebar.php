                                            ...
                                            <ul class="sub-menu">
                                                ...
                                                <li class="menu-item-has-children">
                                                    ...
                                                    <ul class="sub-menu">
                                                        ...
                                                        <li><a class="active" href="blog-single-left-sidebar.php">Blog details left
                                                                sidebar</a></li>
        ...
        <section class="wpo-blog-single-section wpo-blog-single-left-sidebar-section section-padding">
            <div class="container">
                <div class="row">
                    <div class="col col-lg-8 col-12 order-lg-2">
                        <div class="wpo-blog-content">
                            <div class="post format-standard-image">
                                ...
                                <h2>A day in the life of a Home Construction business</h2>
                            ...
                            <div class="author-box">
                                ...
                                <div class="author-content">
                                    <a href="#" class="author-name">Author: invent Think</a>
                    ...
                    <div class="col col-lg-4 col-12 order-lg-1">
